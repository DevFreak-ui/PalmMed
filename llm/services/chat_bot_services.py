...
class ChatBotService:
    ...
    def chat_with_bot_plus_history(self, user_prompt:PromptSchema, context:ContextSchema, chat_id:str):
        try:
            ...
            chat_history = redis_cache.lrange(chat_id, 0, -1)
            if not chat_history:
                chat_history_array = []
            ...
            redis_cache.rpush(chat_id, user_prompt.prompt)
            redis_cache.rpush(chat_id, response.content)
