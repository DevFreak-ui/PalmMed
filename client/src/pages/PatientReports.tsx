const PatientReports = () => {
  return (
   <section className="bg-white dark:bg-gray-900 mt-5 min-h-[83vh] flex  justify-center  ">
      <div className="py-8 px-4 mx-auto max-w-screen-md text-center lg:py-16 lg:px-12">
        ...
        <h1 className="mb-4 text-4xl font-bold tracking-tight leading-none text-gray-900 lg:mb-6 md:text-5xl xl:text-6xl dark:text-white">
          Patient Reports Page <br />
          Under Construction
        </h1>
        <p className="font-light text-gray-500 md:text-lg xl:text-xl dark:text-gray-400">
          Our Developers are working earnestly to get the Patient Reports Page and it's
