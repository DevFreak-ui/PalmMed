        ...
        <div className="w-[45%] flex flex-col mt-8">
          ...
          <article className="py-6 flex-col flex space-y-8">
            <FeatureCard
              ...
              description="Input patient data for heart disease risk prediction using the integrated machine learning model.Receive accurate risk assessments based on patient demographics, medical history, and vital signs."
            />
            <FeatureCard
              title="Final Verdict and Report Generation"
              description="Add personalized final verdicts to prediction model outcomes based on clinical expertise and patient-specific considerations.Generate comprehensive diagnostic reports incorporating prediction model results, doctor's final verdicts, and additional clinical notes."
            />
            <FeatureCard
              title="Chatbot Integration"
              description="Interact with the AI-powered chatbot to gather additional patient information and receive real-time clinical guidance."
            />
          </article>
        </div>
