...
const TopNavDoctor = ({ pageTitle }: TopNavProps) => {
  ...
  return (
    <nav
      className={`bg-white px-4 py-4 dark:bg-gray-800 fixed ${
        isSideNavActive ? "md:ml-64" : "md:ml-20"
      } h-auto left-0 right-0 top-0 z-20`}
    >
      <div className="flex flex-wrap justify-between items-center">
        <div className="flex justify-start items-center">
          ...
          <h1 className="text-3xl font-semibold text-[#05070B]/93 dark:text-slate-400 p-4">
            {" "}
            {pageTitle}{" "}
          </h1>
        </div>
        ...
        <div className="flex items-center lg:order-2">
          ...
          >
            <span id="theme-toggle-light-icon" className="hidden w-5 h-5">
              {" "}
              <WiDaySunny size={20} />{" "}
            </span>
            <span id="theme-toggle-dark-icon" className="hidden w-5 h-5">
              {" "}
              <PiMoon size={20} />{" "}
            </span>
          </button>
          ...
          >
            ...
            >
              <li>
                <a
                  href="/DoctorAccountSettingsPage"
